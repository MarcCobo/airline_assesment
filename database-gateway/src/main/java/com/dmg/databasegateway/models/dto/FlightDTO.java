...
public class FlightDTO {
    ...
    public FlightDTO(long id, String airline, String flight_num, long origin, long destination, LocalDate date, double price, long layover, String layover_text, boolean luggage, double transit_time) {
        this.id = id;
